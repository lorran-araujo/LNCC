...
def calculateCost(objf, population, popSize, lb, ub, trainInput,trainOutput,net):
    ...
    for i in range(0,popSize):
        ...
        scores[i] = objf(population[i,:], trainInput,trainOutput,net) 
...
def GA(objf,lb,ub,dim,popSize,iters, trainInput,trainOutput,net):
    ...
    for l in range(iters):
        ...
        scores = calculateCost(objf, ga, popSize, lb, ub, trainInput,trainOutput,net)
