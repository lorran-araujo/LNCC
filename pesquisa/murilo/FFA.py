...
def FFA(objf,lb,ub,dim,n,MaxGeneration, trainInput,trainOutput,net):
    ...
    for k in range (0,MaxGeneration):     # start iterations
        ...
        for i in range(0,n):
            zn[i]=objf(ns[i,:], trainInput,trainOutput,net)
            Lightn[i]=zn[i]
    ...
    #    
       ####################### End main loop
    timerEnd=time.time()  
    s.iterationTime = s.iterationTime/MaxGeneration
